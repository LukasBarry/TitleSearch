...
ActiveRecord::Schema.define(version: 20170313002630) do
  ...
  create_table "title_companies", force: :cascade do |t|
  ...
  add_index "title_companies", ["user_id"], name: "index_title_companies_on_user_id", using: :btree
  ...
  add_foreign_key "title_companies", "users"
